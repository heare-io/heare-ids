...
The tokens generated by this module are unique, contain a timestamp, and can be used for various purposes such as
access tokens, event tokens, etc. in various applications.

The module also contains a nested class, ParsedToken, which is a named tuple useful for returning multiple values
and referencing them with readable attribute names.
"""
